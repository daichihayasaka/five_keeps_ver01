...
ActiveRecord::Schema.define(version: 2021_10_16_035553) do
  ...
  create_table "link_groups", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
  ...
  add_foreign_key "link_groups", "users"
